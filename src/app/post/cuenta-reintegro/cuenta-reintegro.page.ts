...
import { CuentaService } from 'src/app/servicios/utilidades/cuenta/cuenta.service';
import { TarjetaService } from 'src/app/servicios/utilidades/tarjeta/tarjeta.service';

@Component({
  selector: 'app-cuenta-reintegro',
  templateUrl: './cuenta-reintegro.page.html',
  styleUrls: ['./cuenta-reintegro.page.scss'],
})
